  ...
  var _previousResizeWidth = -1,
    ...
    _parseOptions = function (options) {
      ...
      return 'object' == typeof options
        ? $.extend(opts, options)
        : ('boolean' == typeof options ? (opts.byRow = options) : 'remove' === options && (opts.remove = !0), opts)
    },
    matchHeight = ($.fn.matchHeight = function (options) {
      ...
      return (this.length <= 1 && !opts.target) || (matchHeight._groups.push({ elements: this, options: opts }), matchHeight._apply(this, opts)), this
    })
